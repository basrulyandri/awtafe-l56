  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg">RUBAH PASSWORD</p>
        <form action="{!!route('resetpassword',['reset_password_code' => $reset_password_code])!!}" method="post">
          <div class="form-group has-feedback{{$errors->has('password') ? ' has-error' : ''}}">
            <input type="password" name="password" class="form-control" placeholder="Password Baru" value="{{old('email')}}" autofocus>
