...
@section('content')
  ...
  <section class="content"> 
    <div class="row">
    	<div class="col-md-8">
    		{!!Form::open(['route' => ['collection.update',$collection],'class' => 'form-horizontal','enctype' => 'multipart/form-data'])!!}
    			<div class='form-group{{$errors->has('code') ? ' has-error' : ''}}'>
    				{!!Form::label('code','Kode',['class' => 'col-sm-2 control-label'])!!}
    				<div class="col-sm-10">
    				  {!!Form::text('code',$collection->code,['class' => 'form-control','placeholder' => 'Kode','required' => 'true'])!!}
    				  @if($errors->has('code'))
    			...
    			<div class='form-group{{$errors->has('title') ? ' has-error' : ''}}'>
    				...
    				<div class="col-sm-10">
    				  {!!Form::text('title',$collection->title,['class' => 'form-control','placeholder' => 'Judul','required' => 'true'])!!}
    				  @if($errors->has('title'))
    			...
    			<div class='form-group{{$errors->has('description') ? ' has-error' : ''}}'>
					...
					<div class="col-sm-10">
					  {!!Form::textarea('description',$collection->description,['class' => 'form-control','placeholder' => 'Deskripsi'])!!}
				...
				<div class='form-group{{$errors->has('content') ? ' has-error' : ''}}'>
					...
					<div class="col-sm-10">
					  {!!Form::textarea('content',$collection->content,['class' => 'form-control tinyMCE','placeholder' => 'Konten'])!!}
    	...
    	<div class="col-md-4" role="form">      
    		<div class='form-group{{$errors->has('date') ? ' has-error' : ''}}'>
				{!!Form::label('date','Tanggal Terbit',[])!!}
				  ...
				  {!!Form::text('date',$collection->date->format('Y-m-d'),['class' => 'form-control','placeholder' => 'Tanggal Terbit','required' => 'true','id'=>'tanggalterbit'])!!}
				  @if($errors->has('date'))
      ...
      <div class="from-group">
        ...
        <div class="input-group">
           ...
           <input id="filename" class="form-control" type="text" name="filename" value="{{$collection->filename}}">
         </div>         
       </div>
			<div class="from-group">
        ...
        <div class="input-group">
           ...
           <input id="thumbnail" class="form-control" type="text" name="thumbnail" value="{{$collection->thumbnail}}">
         </div>
         <img src="{{$collection->thumbnail}}" id="holder" style="margin-top:15px;width:100%"> 
       </div>
       <div class="from-group">
