...
@section('content')
  ...
  <section class="content"> 
    <div class="row">
    	<div class="col-md-8">
    		{!!Form::open(['route' => 'book.insert','class' => 'form-horizontal','enctype' => 'multipart/form-data'])!!}
    			<div class='form-group{{$errors->has('code') ? ' has-error' : ''}}'>
    				{!!Form::label('code','Kode',['class' => 'col-sm-2 control-label'])!!}
    				<div class="col-sm-10">
    				  {!!Form::text('code',old('code'),['class' => 'form-control','placeholder' => 'Kode','required' => 'true'])!!}
    				  @if($errors->has('code'))
      ...
      <div class='form-group{{$errors->has('author_id') ? ' has-error' : ''}}'>
        {!!Form::label('author_id','Author',[])!!}        
          {!!Form::select('author_id',$authors,old('author_id'),['class' => 'form-control'])!!}
          ...
          @endif        
    		...
    		<div class='form-group{{$errors->has('date') ? ' has-error' : ''}}'>
				{!!Form::label('date','Tanggal Terbit',[])!!}
				  ...
				  {!!Form::text('date',\Carbon\Carbon::now(),['class' => 'form-control','placeholder' => 'Tanggal Terbit','required' => 'true','id'=>'tanggalterbit'])!!}
				  @if($errors->has('date'))
